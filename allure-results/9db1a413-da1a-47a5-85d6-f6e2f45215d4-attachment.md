...
Call log:
  - waiting for locator('tbody tr td:nth-child(3) a').first()
    - waiting for" https://console.ationet.com/TransactionsRejected" navigation to finish...
    - navigated to "https://console.ationet.com/TransactionsRejected"

    at body (/home/maxii1221/testAuto/tests/Atio lab Flota/NWCompany/flota/transaccionesRechazadas.spec.ts:97:70)
    ...
    at body (/home/maxii1221/testAuto/tests/Atio lab Flota/NWCompany/flota/transaccionesRechazadas.spec.ts:96:22)
    at body (/home/maxii1221/testAuto/node_modules/allure-js-commons/src/facade.ts:113:48)
    at call (/home/maxii1221/testAuto/node_modules/allure-playwright/src/runtime.ts:13:56)
    at tryCatch (/home/maxii1221/testAuto/node_modules/allure-playwright/src/runtime.ts:2:1)
    at Generator._invoke (/home/maxii1221/testAuto/node_modules/allure-playwright/src/runtime.ts:2:1)
...
```ts
   ...
   3 |
   4 |
   5 | test('Transacciones Rechazadas', async ({ page }, testInfo) => {
   6 |     //varibles:
...
>  97 |             await page.locator('tbody tr td:nth-child(3) a').first().click();
   ...
   99 |
  100 |
  101 |         await allure.step('Click en boton Ok', async () => {
  102 |         await page.getByRole('button', { name: 'Ok' }).click({ noWaitAfter: true });
  103 |         await page.waitForTimeout(1000); // o un wait por una condición
  104 |         });
  105 |
  106 |         // await allure.step('Verificamos que volvimos a la url de transacciones rechazadas' , async () => {
  107 |         //     await expect(page).toHaveURL('https://console.ationet.com/TransactionsRejected');
  108 |         // });
  109 |     });
  110 |
  111 | })
