...
test('Identificaciones solicitadas', async ({ page }, testInfo) => {
    ...
    //acceder a modulo contrato de identificaciones solicitadas
    await page.click('a[href="/IdentificationsRequests"]'); // Haz clic en el enlace
    
    //veriricar que estamos en la url de identificaciones solicitadas
