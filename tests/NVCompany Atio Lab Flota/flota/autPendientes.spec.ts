...
test('Autorizaciones Pendientes', async ({ page }, testInfo) => {
    ...
    //acceder a modulo contrato de Autorizaciones Pendientes
    await page.click('a[href="/TransactionsOutstandingAuthorizations"]'); // Haz clic en el enlace
    ...
    //veriricar que estamos en la url de contrato de Autorizaciones Pendientes
