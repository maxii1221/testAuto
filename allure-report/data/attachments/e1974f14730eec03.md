...
Call log:
  ...
  - attempting click action
    ...
    at body (/home/maxii1221/testAuto/tests/Atio lab Flota/NWCompany/flota/excepciones.spec.ts:104:60)
    ...
    at /home/maxii1221/testAuto/tests/Atio lab Flota/NWCompany/flota/excepciones.spec.ts:103:22
```
...
> 104 |             await page.getByRole('button', { name: 'Ok' }).click();
  ...
  106 |   
  107 |
  108 |         await allure.step('espera de carga', async () => {
  109 |             await page.waitForTimeout(5000); // espera 2 segundos
  110 |         });
  111 |     });
  112 | })
```